// idInterpolateAccelDecelLinear < idVec3 , idTypesafeTime < long long , gameTimeUnique_t , 999960 > >
template <typename _value_type_, typename _time_type_>
struct idInterpolateAccelDecelLinear
{
    ...
    idExtrapolate < _value_type_ , _time_type_ > extrapolate; // Offset: 0x38
