struct idDeclUICustomData_EndOfLevel_Horde : idGameDeclTypeInfo
{
    ...
    // Default info
    idDeclUICustomData_EndOfLevel_Horde::defaultInfo_t defaultInfo; // Offset: 0x90

    // Animation durations
    idDeclUICustomData_EndOfLevel_Horde::animationDurations_t animationDurations; // Offset: 0xA0

    // sounds to play during various bits of animation
    idDeclUICustomData_EndOfLevel_Horde::soundEvents_t soundEvents; // Offset: 0xB8
